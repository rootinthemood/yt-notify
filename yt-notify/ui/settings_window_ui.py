...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.gridLayout.addWidget(self.vlc_args, 1, 2, 1, 1)
        self.mpv_label = QtWidgets.QLabel(Form)
        self.mpv_label.setObjectName("mpv_label")
        self.gridLayout.addWidget(self.mpv_label, 0, 1, 1, 1)
        self.vlc_label = QtWidgets.QLabel(Form)
        self.vlc_label.setObjectName("vlc_label")
        self.gridLayout.addWidget(self.vlc_label, 1, 1, 1, 1)
        self.mpv_args = QtWidgets.QLineEdit(Form)
        self.mpv_args.setText("")
        self.mpv_args.setObjectName("mpv_args")
        self.gridLayout.addWidget(self.mpv_args, 0, 2, 1, 1)
        self.dark_combo = QtWidgets.QComboBox(Form)
        self.dark_combo.setObjectName("dark_combo")
        self.gridLayout.addWidget(self.dark_combo, 2, 2, 1, 1)
        self.dark_label = QtWidgets.QLabel(Form)
        self.dark_label.setObjectName("dark_label")
        self.gridLayout.addWidget(self.dark_label, 2, 1, 1, 1)
    ...
    def retranslateUi(self, Form):
        ...
        self.dark_label.setText(_translate("Form", "Dark/Light"))
